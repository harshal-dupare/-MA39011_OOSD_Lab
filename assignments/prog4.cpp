...
Class : 4
Date : 25-9-2020
Details: 4) Overload the * operator for the class Number.
*/
...
public:
	...
	// gets number from the user as string input and assigns to the num
	...
	Number operator * (Number fint)
	{
	    ...
	    for(int i=0; i<n1; i++) 
	    {
	    	...
	    	for(int k=0; k<i; k++)
	    	{
	    		temp.push_back('0'); // adding the i number of zeros as multiplying by i'th digit so need to shift by that many zeros
	    	}
...
int main()
{
	...
	// mult n1 and n2 and storing it in n3
	n3=n1*n2;
